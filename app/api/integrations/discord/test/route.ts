...
import { sendToDiscord, sendDiscordEmbed } from '../send/route';
...
export async function GET(request: NextRequest) {
  try {
    ...
    await sendToDiscord('🧪 ทดสอบการส่งข้อความจากระบบ AI Code Review & Deployment Monitoring');
    
    // ทดสอบส่ง embed
    const testEmbed = [
      {
        title: '🚀 ทดสอบการส่ง Embed',
        description: 'นี่เป็นการทดสอบการส่ง embed ไปยัง Discord จากระบบ AI Code Review & Deployment Monitoring',
