...
export default function Demo() {
  return (
    <div className="py-20 bg-gray-50 overflow-hidden" id="demo">
            ...
            <div className="mt-6 p-4 bg-[#36393f] rounded-lg shadow-lg text-white">
              ...
              <div className="border-l-4 border-[#5865F2] pl-3 py-1">
                <div className="font-semibold">
                  🚀 มีการ Deploy โปรเจ็ค ecommerce-website
                </div>
                <div className="text-sm text-gray-300 mt-1">
                  มีการ deploy โค้ดไปยัง branch main โดย john_dev
                </div>

                <div className="grid grid-cols-2 gap-2 mt-2 text-xs">
                  <div>
                    <span className="text-gray-400">📂 โปรเจ็ค:</span>{" "}
                    ecommerce-website
                  </div>
                  <div>
                  ...
                  <div>
                    <span className="text-gray-400">👨‍💻 ผู้ Deploy:</span>{" "}
                    john_dev
                  </div>
                  <div>
                ...
                <div className="mt-2 text-xs">
                  <span className="text-gray-400">📝 Commit Message:</span> Fix
                  product search functionality and improve performance
                </div>
              </div>
            </div>
          </div>
