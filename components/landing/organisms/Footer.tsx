    ...
    <footer className="bg-gray-100 text-gray-700 py-8 border-t border-gray-200">
      <div className="container mx-auto px-8">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl text-gray-900">AI Review</span>
            </div>
            <p className="text-gray-600 text-sm">
              ระบบติดตามคุณภาพโค้ดและแจ้งเตือน Deployment
              สำหรับทีมพัฒนาภายในบริษัท
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li className="flex items-center">
                ...
                <span>Peem</span>,<span>Ice</span>,<span>Boy</span>
              </li>
              <li className="flex items-center">
                <svg
                  className="w-4 h-4 mr-2 text-blue-600"
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 text-center text-gray-600 text-sm">
          <p>
            © {new Date().getFullYear()} [ชื่อบริษัทของคุณ] - ระบบพัฒนาโดยทีม
            Ai Code Review
          </p>
        </div>
      </div>
