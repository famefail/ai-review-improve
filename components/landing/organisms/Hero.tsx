  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div className="absolute top-10 left-10 w-64 h-64 bg-white opacity-5 rounded-full transform -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute top-1/3 right-0 w-96 h-96 bg-blue-400 opacity-10 rounded-full blur-2xl" />
        <div className="absolute bottom-0 left-1/3 w-72 h-72 bg-indigo-300 opacity-10 rounded-full blur-xl" />
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left mb-12 md:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              AI <span className="text-blue-300">Code Review</span> & Deployment
              Monitoring
            </h1>
            <p className="text-xl md:text-2xl mb-10 text-blue-100 max-w-xl leading-relaxed">
              ยกระดับการพัฒนาโค้ดด้วยระบบติดตามคุณภาพและแจ้งเตือน Deployment
              อัตโนมัติ
            </p>
...
✓ Sending notification to Discord...`}
                ...
                <div className="mt-4 bg-blue-600 bg-opacity-20 rounded-md p-3">
                  ...
                  <p className="text-xs text-blue-100 mt-2">
                    โค้ดมีคุณภาพดี
                    แต่พบส่วนที่สามารถปรับปรุงประสิทธิภาพได้ในฟังก์ชัน
                    processData()
                  </p>
                </div>
              </div>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none transform translate-y-1">
        ...
        >
          <path
            d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V0C0,0,0,24,0,48Z"
            fill="currentColor"
          />
        </svg>
      </div>
